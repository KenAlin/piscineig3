      ...
      <div class="card-content">
        ...
        <ul>
          <?php if(isset($pret["dateRetour"])) {
            ...
            echo "<li class=\"red-text text-darken-2\"><b>Prêt rendu le {$strDateRetour}.</b></li>";
          } ?>

          <?php if(!isset($pret["dateRetour"]) && $pret["dateFin"] < time()) echo "<li class=\"blue-text text-darken-2\"><b>Prêt en retard !</b></li>"; ?>

          <li><i class="fa fa-dashboard"></i> <b>Exemplaire :</b> <a href="exemplaire-<?php echo $pret["idExemplaire"]; ?>"><?php echo $pret["idExemplaire"]; ?></a> du jeu <a href="jeu-<?php echo $infosJeu["id"]; ?>"><?php echo $infosJeu["nom"]; ?></a></li>
